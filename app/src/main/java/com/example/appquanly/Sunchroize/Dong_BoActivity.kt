...
class Dong_BoActivity : AppCompatActivity(), SyncDataContract.View {

    private lateinit var presenter: SyncDataContract.Presenter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Khởi tạo Presenter
        presenter = SyncDataPresenter(this)
