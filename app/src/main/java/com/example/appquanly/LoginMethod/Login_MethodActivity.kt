...
class Login_MethodActivity : AppCompatActivity(), Login_MethodContract.View {

    private lateinit var presenter: Login_MethodContract.Presenter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_login_with_phone_email)

        presenter = Login_MethodPresenter(this)
