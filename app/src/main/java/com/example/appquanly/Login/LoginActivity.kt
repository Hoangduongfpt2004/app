...
import com.example.appquanly.LoginMethod.Login_MethodActivity
import com.example.appquanly.Register.RegisterActivity
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textPhoneEmail.setOnClickListener {
            val intent = Intent(this, Login_MethodActivity::class.java)
