package com.example.appquanly.banhang.view
...
import com.example.appquanly.Bao_Cao.view.Bao_CaoActivity
import com.example.appquanly.R
import com.example.appquanly.ThucDon.view.ThucDonActivity
import com.example.appquanly.banhang.contract.BanHangContract
import com.example.appquanly.banhang.persenter.BanHangPresenter
...
class BanHangActivity : AppCompatActivity(), BanHangContract.View {
    ...
    override fun showNoOrders() {
        tvHint.text = "Chưa có đơn hàng"
    }

    override fun openOrderScreen() {
        Toast.makeText(this, "Mở màn hình chọn món", Toast.LENGTH_SHORT).show()
    ...
    fun Dong_Bo_Du_Lieu () {
        val intent = Intent(this,Dong_Bo_Du_Lieu()::class.java)
        startActivity(intent)
    }

    fun Thiet_Lap () {
        val intent = Intent(this,Thiet_Lap()::class.java)
        startActivity(intent)
    }
    ...
    // Phương thức onMenuItemClicked được khai báo ngoài navigateTo
