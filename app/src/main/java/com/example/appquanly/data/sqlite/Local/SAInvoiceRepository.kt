        ...
        if (cursor.moveToFirst()) {
            do {
                val invoice = SAInvoiceItem(
                    ...
                    createdDate = cursor.getLongOrNull(cursor.getColumnIndexOrThrow("CreatedDate")),
                    createdBy = cursor.getString(cursor.getColumnIndexOrThrow("CreatedBy")),
                    modifiedDate = cursor.getLongOrNull(cursor.getColumnIndexOrThrow("ModifiedDate")),
